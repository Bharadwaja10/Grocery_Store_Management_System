...
def get_order_details(connection, order_id):
    ...
    query = ("SELECT order_details.order_id, order_details.quantity, order_details.Total, "
             "product_table.product_name, product_table.price_per_unit "
             "FROM order_details LEFT JOIN product_table ON order_details.product_id = product_table.product_id "
